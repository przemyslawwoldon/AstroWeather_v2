...
public class NextDayFragmentLand extends Fragment {
    ...
    public NextDayFragmentLand() {
    }

    public static NextDayFragmentLand newInstance() {
        NextDayFragmentLand fragment = new NextDayFragmentLand();
        return fragment;
    }
