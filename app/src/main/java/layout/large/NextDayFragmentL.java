...
public class NextDayFragmentL extends Fragment {
    ...
    public NextDayFragmentL() {
    }

    public static NextDayFragmentL newInstance() {
        NextDayFragmentL fragment = new NextDayFragmentL();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_next_day_l, container, false);
